...
http.listen(3000, function () {
  ...
  mongoClient.connect("mongodb://localhost:27017", function (error, client) {
    ...
    app.post("/uploadCoverPhoto", function (request, result, next) {
      var accessToken = request.fields.accessToken;
      var coverPhoto = "";
        ...
        function (error, user) {
          if (user == null) {
            ...
            if (
              ...
              request.files.coverPhoto.name;
              mv(request.files.coverPhoto.path, coverPhoto, function (error) {
                //
              });
        ...
        function (error, user) {
          if (user == null) {
            ...
            if (
              ...
              mv(request.files.image.path, image, function (error) {
                //
              });
            }
            ...
            if (
              ...
              mv(request.files.video.path, video, function (error) {
                //
              });
            }
